import es.us.spark.mllib.clustering.validation.{ExternalValidation, FeatureStatistics}
...
object MainTest {
  def main(args: Array[String]): Unit = {
    ...
    println("CRITERION H:")
    val criterionH = ExternalValidation.getCriterionH(df)
    println(criterionH)

    println("CSI:")
    val csi = ExternalValidation.getCSI(df)
    println(csi)
